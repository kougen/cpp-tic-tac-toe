...
void offlineMode(string player1, string player2) {
  ...
  // NOTE: Matrix for storing the data of the game as it plays out.
  char A[32][62];
  ...
  while (isRunning) {
    ...
    // NOTE: Putting the starter board on the console, aswell as saving1 it in a
    // matrix.
    if (newGame) {
      cout << endl;
      for (int i = 0; i < 32; i++) {
    ...
    // NOTE: So they know who is next, and we can use it later aswell to know if
    // the next symbol is an X or O.
    if (whosNext % 2 == 0 && gamesPlayed % 2 == 0)
      cout << endl << "[" << player1 << " (X)]" << endl;
    else if (whosNext % 2 == 1 && gamesPlayed % 2 == 0) {
      cout << endl << "[" << player2 << " (O)]" << endl;
    } else if (whosNext % 2 == 0 && gamesPlayed % 2 == 1) {
      cout << endl << "[" << player2 << " (X)]" << endl;
    } else if (whosNext % 2 == 1 && gamesPlayed % 2 == 1) {
      cout << endl << "[" << player1 << " (O)]" << endl;
    }
    cout << "Enter the number of the row you want to place your piece in: ";
    cin >> row;

    // NOTE: If they give a different number than how many rows we have.
    if (row < 1 || row > 3) {
      while (row < 1 || row > 3) {
    ...
    // NOTE: If they give a different number than how many columns we have.
    if (column < 1 || column > 3) {
      while (column < 1 || column > 3) {
        cout << "The range of the column is 1-3." << endl;
        cout << "Enter the number of the column you want to place your piece "
                "in: ";
        cin >> column;
      }
    }
    ...
    cout << "You placed your piece in column " << column << " and row " << row
         << endl;
    // NOTE: If that spot already has a symbol than ask for another one that is
    // not occupied.
    if (B[row - 1][column - 1] == 0) {
      B[row - 1][column - 1] = 1;
    } else {
      while (B[row][column] != 0) {
        ...
        // NOTE: So they know who is next, and we can use it later aswell to
        // know if the next symbol is an X or O.
        if (whosNext % 2 == 0) {
          cout << endl << "[" << player1 << "(X)]" << endl;
        } else {
          cout << endl << "[" << player2 << "(O)]" << endl;
        ...
        if (row < 1 || row > 3) {
          while (row < 1 || row > 3) {
            cout << "The range of the row is 1-3." << endl;
            cout << "Enter the number of the row you want to place your piece "
                    "in: ";
            cin >> row;
          }
        }
        ...
        if (column < 1 || column > 3) {
          while (column < 1 || column > 3) {
            cout << "The range of the column is 1-3." << endl;
            cout << "Enter the number of the column you want to place your "
                    "piece in: ";
            cin >> column;
          }
        }
        ...
        cout << "You placed your piece in column " << column << " and row "
             << row << endl;
      }
      B[column][row] = 1;
    }
    // TODO: Game logic starts/goes here!
    // NOTE: In this we will have to put 9 "if"s to check which cell the symbol
    // has been put in.
    if (whosNext % 2 == 0) {
      if (column == 1 && row == 1) {
        for (int i = 0; i < 11; i++) {
    ...
    whosNext++;
    takenSpots++;
    // NOTE: Here starts the winner score counter and etc. like player1 wins:2
    // player2 wins:1
    if (C[0][0] != 2 && C[0][0] != 1 && C[0][0] == C[0][1] &&
        C[0][0] == C[0][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      D[0]++;
      cout << endl
           << player1 << " wins:" << D[0] << endl
           << player2 << " wins:" << D[1] << endl;
      cout << "Do you want to play again? (y/n) ";
      cin >> answer;
      isRunning = (answer == 'y' || answer == 'Y');
      newGame = true;
      gamesPlayed++;
    } else if (C[1][0] != 2 && C[1][0] != 1 && C[1][0] == C[1][1] &&
               C[1][0] == C[1][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[2][0] != 2 && C[2][0] != 1 && C[2][0] == C[2][1] &&
               C[2][0] == C[2][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][1] != 2 && C[0][1] != 1 && C[0][1] == C[1][1] &&
               C[0][1] == C[2][1]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][0] != 2 && C[0][0] != 1 && C[0][0] == C[1][0] &&
               C[0][0] == C[2][0]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][2] != 2 && C[0][2] != 1 && C[0][2] == C[1][2] &&
               C[0][2] == C[2][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][0] != 2 && C[0][0] != 1 && C[0][0] == C[1][1] &&
               C[0][0] == C[2][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][2] != 2 && C[0][2] != 1 && C[0][2] == C[1][1] &&
               C[0][2] == C[2][0]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][0] != 2 && C[0][0] != 0 && C[0][0] == C[0][1] &&
               C[0][0] == C[0][2]) // NOTE: 2nd player won
    {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[1][0] != 2 && C[1][0] != 0 && C[1][0] == C[1][1] &&
               C[1][0] == C[1][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[2][0] != 2 && C[2][0] != 0 && C[2][0] == C[2][0] &&
               C[2][0] == C[2][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][1] != 2 && C[0][1] != 0 && C[0][1] == C[1][1] &&
               C[0][1] == C[2][1]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][0] != 2 && C[0][0] != 2 && C[0][0] == C[1][0] &&
               C[0][0] == C[2][0]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][2] != 2 && C[0][2] != 0 && C[0][2] == C[1][2] &&
               C[0][2] == C[2][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][0] != 2 && C[0][0] != 0 && C[0][0] == C[1][1] &&
               C[0][0] == C[2][2]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (C[0][2] != 2 && C[0][2] != 0 && C[0][2] == C[1][1] &&
               C[0][2] == C[2][0]) {
      for (int i = 0; i < 32; i++) {
        for (int j = 0; j < 62; j++) {
          cout << A[i][j];
      ...
      newGame = true;
      gamesPlayed++;
    } else if (B[0][0] == 1 && B[0][1] == 1 && B[0][2] == 1 && B[1][0] == 1 &&
               B[1][1] == 1 && B[1][2] == 1 && B[2][0] == 1 && B[2][1] == 1 &&
               B[2][2] == 1) {
